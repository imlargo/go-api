...
// VideoFingerprint returns cache key for a video fingerprint by URL
func (ck *CacheKeys) VideoFingerprint(videoURL string) string {
	params := map[string]interface{}{
		"url": videoURL,
	}
	return ck.builder.BuildForQuery("fingerprint", "video", params)
}
